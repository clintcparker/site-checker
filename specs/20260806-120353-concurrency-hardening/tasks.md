...
- **`[~]`**: partially complete — the by-eye code reads were done, the GUI click-through was
  not. Only T025 and T040 carry it. See "Not done, and not claimable" in the Notes.
